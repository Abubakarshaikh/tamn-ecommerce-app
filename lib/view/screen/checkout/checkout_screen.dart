...
import 'package:flutter_sixvalley_ecommerce/view/screen/checkout/receipt_updated_page.dart';
...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  Future<void> _performtrxn(BuildContext context, String transType,
      {String amount}) async {
    var lastResult = "";
                  ...
                  ? Builder(
                      builder: (context) => InkWell(
                        onTap: () async {
                          ...
                          context
                              .read<CartProvider>()
                              .removeCheckoutProduct(_cartData);
                          // await _performtrxn(context, "hosted",
                          //     amount: _order.toString());
